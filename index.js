...
app.use(express.json());
    ...
    app.get('/', (req, res) => {
        res.send('Welcome to Backend test <br/> /register for registering a user(POST) <br/> /login for user login and generating api_key(POST) <br/> /blog for creating a blog post(please provide api_key in header)(Title and Description is required in the body)(POST) <br/> /blogs for getting all blog posts for a user(please provide api_key in header)(GET)');
